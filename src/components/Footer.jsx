    ...
    <footer className="relative bg-black text-white py-12 px-6 md:px-16 h-screen flex flex-col justify-between overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col h-full justify-between">
        ...
        <div className="flex flex-wrap justify-between items-center py-6 border-t border-white/10 mb-4 text-sm md:text-lg font-medium">
          <a href="https://www.instagram.com/smart_sunil07?igsh=MWhqcnVnMGx1bG1jMg==" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300 transition-colors">Instagram</a>
          <a href="https://www.linkedin.com/in/sunil-kumar-r-542013328/" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300 transition-colors">LinkedIn</a>
          <a href="https://github.com/sunilkumar2731" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300 transition-colors">Github</a>
        </div>

        {/* Huge Text Section */}
        <div className="w-full text-center flex-1 flex items-center justify-center min-h-0">
          <h1 className="text-[10vw] font-bold leading-none tracking-tighter" style={{ fontFamily: 'Inter, sans-serif' }}>
            SUNIL KUMAR
          </h1>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-xs text-gray-400 mt-auto pt-6">
          <p>© {new Date().getFullYear()} Sunil Kumar. All Rights Reserved.</p>
